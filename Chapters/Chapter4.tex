...
Nous avons pensé à rajouter un module d’archives qui sauvegarde des logs datés et classés par ordre chronologique sur les caractéristiques et les informations des flux  comme la date et la durée du flux, les adresses IP source et destination et bien d’autres,  ainsi que leurs cluster (flux bénin ou flux d’attaque). Ce module d’archive servira à l’analyse périodique de l’efficacité du système de détection.
